  ...
  return (
    <form className="filter" action="http://echo.htmlacademy.ru" method="GET">
      ...
      <fieldset className="filter__fieldset filter__fieldset--price-range">
        ...
        <input className="filter__price filter__price--from" type="text" name="filter-by-price-from" id="filter-by-price-from" value="1 000" readOnly /> 
        <input className="filter__price filter__price--to" type="text" name="filter-by-price-to" id="filter-by-price-to" value="30 000" readOnly /> 
      </fieldset>
